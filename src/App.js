    ...
    <section id="about-section" style={{ padding: isMobile ? "80px 24px" : "120px 48px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 48 : 80, alignItems: "center" }}>
        ...
        <Reveal delay={isMobile ? 0 : 0.2}>
          <div>
            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 20 }}>ABOUT</div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 36 }}>
              {GENRES.map(g => <span key={g} style={{ fontFamily: "'Outfit', sans-serif", fontSize: 17, letterSpacing: 2, color: "rgba(140,100,30,0.85)", border: "1px solid rgba(180,140,80,0.2)", borderRadius: 1, padding: "5px 12px" }}>{g}</span>)}
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "rgba(26,24,21,0.08)" }}>
              {[["4+", "Years"], ["4.9★", "Rated"], ["UK", "& Beyond"]].map(([val, label]) => (
                <div key={label} style={{ background: "#ede8df", padding: "20px 16px" }}>
                  <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: "#1a1815", fontStyle: "italic" }}>{val}</div>
                  <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 2.5, color: "rgba(26,24,21,0.4)", marginTop: 4 }}>{label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <Reveal>
          <div style={{ marginBottom: 48 }}>
            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16 }}>LISTEN</div>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: "#1a1815", margin: "0 0 8px" }}>Hear the Sound</h2>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 17, color: "rgba(26,24,21,0.55)", lineHeight: 1.65, maxWidth: 480 }}>A selection of recorded sets — the best way to get a feel for the vibe before you book.</p>
          </div>
        </Reveal>
            ...
            <Reveal key={mix.id} delay={i * 0.15}>
              <div style={{ background: "#fff", padding: isMobile ? "20px 18px" : "28px 28px 24px", borderRadius: isMobile ? 4 : 0, border: "1px solid rgba(26,24,21,0.07)", display: "flex", flexDirection: "column" }}>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16, flexDirection: "row", gap: 12 }}>
                  ...
                  <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, letterSpacing: 1.5, color: "rgba(140,100,30,0.85)", border: "1px solid rgba(180,140,80,0.2)", padding: "4px 10px", borderRadius: 1, whiteSpace: "nowrap", flexShrink: 0 }}>{mix.tag}</span>
                </div>
                ...
                <div style={{ marginTop: 12, textAlign: "right" }}>
                  <a href="https://www.mixcloud.com/DJAppz/" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, letterSpacing: 2, color: "rgba(140,100,30,0.7)", textDecoration: "none" }}>MORE ON MIXCLOUD →</a>
                </div>
              </div>
            </Reveal>
          ))}
  ...
  return (
    <section style={{ padding: isMobile ? "56px 24px" : "80px 48px", textAlign: "center", background: "#f5f0e8" }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        <Reveal>
          <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16, textTransform: "uppercase" }}>Welcome</div>
  ...
  return (
    <section style={{ padding: isMobile ? "64px 24px" : "96px 48px", background: "rgba(26,24,21,0.03)" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <Reveal>
          <div style={{ marginBottom: 48 }}>
            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16 }}>EXPLORE</div>
            ...
            <Reveal key={c.id} delay={i * 0.1}>
              ...
              >
                <div>
                  ...
                  <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, letterSpacing: 2.5, color: "rgba(140,100,30,0.8)", marginBottom: 8, textTransform: "uppercase" }}>{c.tag}</div>
  ...
  return (
    <section style={{ padding: isMobile ? "80px 24px" : "120px 48px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <Reveal>
          <div style={{ marginBottom: 48 }}>
            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16 }}>SERVICES</div>
            ...
            <Reveal key={s.id} delay={i * 0.1}>
              <div onClick={() => onBook(s.id)} style={{ background: "#fff", padding: isMobile ? "28px 24px" : "44px 40px", cursor: "pointer", transition: "background 0.3s", borderRadius: isMobile ? 4 : 0, border: "1px solid rgba(26,24,21,0.06)" }} onMouseEnter={e => e.currentTarget.style.background = "#ede8df"} onMouseLeave={e => e.currentTarget.style.background = "#fff"}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 12, color: "rgba(140,100,30,0.8)", letterSpacing: 2 }}>ENQUIRE →</span>
                </div>
              </div>
            </Reveal>
          ))}
  ...
  return (
    <section style={{ padding: isMobile ? "64px 24px" : "96px 48px", background: "rgba(26,24,21,0.03)" }}>
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        <Reveal>
          <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 40 }}>KIND WORDS</div>
  ...
  return (
    <section style={{ padding: isMobile ? "80px 24px" : "120px 48px" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        <Reveal>
          <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16 }}>FAQ</div>
        ...
        <div style={{ position: "absolute", top: "calc(100% + 8px)", left: isMobile ? "50%" : 0, transform: isMobile ? "translateX(-50%)" : "none", zIndex: 300, background: "#faf7f2", border: "1px solid rgba(26,24,21,0.15)", borderRadius: 4, padding: 16, width: isMobile ? "calc(100vw - 48px)" : 300, boxShadow: "0 20px 60px rgba(0,0,0,0.8)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2 }}>
            ...
            {Array.from({ length: daysInMonth }).map((_, i) => {
              ...
              return (
                <button type="button" key={day} onClick={() => !past && selectDate(day)} style={{ background: sel ? "rgba(140,100,30,0.95)" : tod ? "rgba(26,24,21,0.1)" : "none", border: tod && !sel ? "1px solid rgba(180,140,80,0.3)" : "1px solid transparent", borderRadius: 2, padding: "8px 0", fontFamily: "'Outfit', sans-serif", fontSize: 14, color: past ? "rgba(26,24,21,0.2)" : sel ? "#f5f0e8" : "#1a1815", cursor: past ? "not-allowed" : "pointer", textAlign: "center", fontWeight: sel ? 600 : 400 }}
          ...
          <div style={{ marginTop: 12, textAlign: "right" }}>
            <button type="button" onClick={() => setOpen(false)} style={{ background: "none", border: "none", fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 2, color: "rgba(26,24,21,0.35)", cursor: "pointer" }}>CLOSE</button>
          </div>
        </div>
      )}
    </div>
...
function BookingSection({ prefill, onSuccess, onPrivacyClick }) {
  ...
  return (
    <section style={{ padding: isMobile ? "80px 24px" : "120px 48px" }}>
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        <Reveal>
          <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16 }}>ENQUIRIES</div>
  ...
  return (
    <section style={{ padding: isMobile ? "80px 24px" : "120px 48px", minHeight: "80vh", display: "flex", alignItems: "center" }}>
      <div style={{ maxWidth: 580, margin: "0 auto", textAlign: "center", opacity: show ? 1 : 0, transform: show ? "none" : "translateY(24px)", transition: "opacity 0.7s ease, transform 0.7s ease" }}>
        ...
        <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, letterSpacing: 4, color: "rgba(140,100,30,0.85)", marginBottom: 16 }}>ENQUIRY RECEIVED</div>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: "#1a1815", margin: "0 0 20px", lineHeight: 1.2 }}>You're on our <em>radar</em>, {form.name.split(" ")[0]}.</h2>
        ...
        <div style={{ background: "rgba(26,24,21,0.02)", border: "1px solid rgba(26,24,21,0.1)", borderRadius: 4, padding: "20px 24px", textAlign: "left", marginBottom: 20 }}>
          <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 3, color: "rgba(26,24,21,0.3)", marginBottom: 14 }}>YOUR BOOKING SUMMARY</div>
          {[["Event Type", form.eventType], ["Date", form.date], ["Venue", form.venue || "TBC"], ["Guests", form.guests || "TBC"], ["Budget", form.budget || "TBC"]].map(([k, v]) => (
            <div key={k} style={{ display: "flex", justifyContent: "space-between", padding: "9px 0", borderBottom: "1px solid rgba(26,24,21,0.08)", fontFamily: "'Outfit', sans-serif", fontSize: 15 }}>
        ...
        <div style={{ background: "rgba(26,24,21,0.02)", border: "1px solid rgba(26,24,21,0.1)", borderRadius: 4, padding: "20px 24px", textAlign: "left", marginBottom: 28 }}>
          <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 3, color: "rgba(26,24,21,0.3)", marginBottom: 16 }}>WHAT HAPPENS NEXT</div>
          {[["01", "We review your enquiry and check availability for your date"], ["02", "You'll receive a personalised response within 24 hours"], ["03", "We'll confirm details, discuss your music preferences, and send a quote"], ["04", "A 25% deposit secures your booking"]].map(([num, text]) => (
            <div key={num} style={{ display: "flex", gap: 14, marginBottom: 14, alignItems: "flex-start" }}>
              <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 20, color: "rgba(140,100,30,0.6)", fontStyle: "italic", flexShrink: 0, lineHeight: 1.4 }}>{num}</span>
              <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 14, color: "rgba(26,24,21,0.5)", lineHeight: 1.7 }}>{text}</span>
            </div>
          ))}
        </div>
        <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "rgba(26,24,21,0.3)", letterSpacing: 1 }}>Direct line: <span style={{ color: "rgba(140,100,30,0.75)" }}>{DJ.email}</span></p>
      </div>
    </section>
  );
}
...
function FooterBar({ onPrivacy }) {
  ...
  return (
    <footer style={{ borderTop: "1px solid rgba(26,24,21,0.08)", padding: isMobile ? "32px 24px" : "40px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
      <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 16, color: "rgba(26,24,21,0.5)", fontStyle: "italic", letterSpacing: 2 }}>DJ Appz</span>
      <div style={{ display: "flex", gap: isMobile ? 16 : 28, flexWrap: "wrap" }}>
        {[DJ.instagram, DJ.email, DJ.location].map(l => <span key={l} style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 1.5, color: "rgba(26,24,21,0.3)" }}>{l}</span>)}
      </div>
      <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 1, color: "rgba(26,24,21,0.25)" }}>© 2026 DJ Appz</span>
    </footer>
  );
}
...
function PrivacyModal({ onClose }) {
  ...
  return (
    <div
      ...
      style={{ position: "fixed", inset: 0, zIndex: 500, background: "rgba(26,24,21,0.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 16px" }}
    >
      <div style={{ background: "#faf7f2", borderRadius: 4, width: "100%", maxWidth: 640, maxHeight: "85vh", display: "flex", flexDirection: "column", boxShadow: "0 24px 80px rgba(0,0,0,0.2)" }}>
        {/* Header */}
        <div style={{ padding: "24px 28px 20px", borderBottom: "1px solid rgba(26,24,21,0.1)", display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexShrink: 0 }}>
          <div>
            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: 14, letterSpacing: 3, color: "rgba(140,100,30,0.8)", marginBottom: 6, textTransform: "uppercase" }}>Legal</div>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: "#1a1815", margin: "0 0 4px", fontWeight: 500 }}>Privacy Policy</h2>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, color: "rgba(26,24,21,0.4)", margin: 0 }}>DJ Appz · Last updated May 2026</p>
          </div>
          <button onClick={onClose} style={{ background: "none", border: "1px solid rgba(26,24,21,0.15)", borderRadius: 2, width: 36, height: 36, cursor: "pointer", fontSize: 16, color: "#1a1815", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginLeft: 16 }}>✕</button>
        </div>
        {/* Scrollable content */}
        <div style={{ overflowY: "auto", padding: "24px 28px", flex: 1 }}>
          {sections.map((s, i) => (
            <div key={i} style={{ marginBottom: 28 }}>
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 14, color: "#1a1815", margin: "0 0 10px", fontWeight: 500, borderBottom: "1px solid rgba(26,24,21,0.08)", paddingBottom: 8 }}>{s.title}</h3>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 12, color: "rgba(26,24,21,0.65)", lineHeight: 1.8, margin: 0, whiteSpace: "pre-line" }}>{s.body}</p>
            </div>
          ))}
        </div>
        {/* Footer */}
        <div style={{ padding: "16px 28px", borderTop: "1px solid rgba(26,24,21,0.08)", flexShrink: 0 }}>
          <button onClick={onClose} style={{ background: "#1a1815", color: "#f5f0e8", border: "none", borderRadius: 2, padding: "11px 28px", fontFamily: "'Outfit', sans-serif", fontSize: 11, letterSpacing: 2, textTransform: "uppercase", cursor: "pointer", width: "100%" }}>
            Close
          </button>
        </div>
      </div>
    ...
    <section style={{ padding: isMobile ? "80px 24px" : "100px 48px" }}>
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        <Reveal>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: "#1a1815", margin: "0 0 8px" }}>Privacy Policy</h1>
            ...
            <Reveal key={mix.id} delay={i * 0.1}>
              <div style={{ background: "#fff", padding: isMobile ? "24px 20px" : "32px 40px", display: "flex", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 20 : 40, alignItems: isMobile ? "flex-start" : "center" }}>
                ...
                <div style={{ flex: "0 0 auto", width: isMobile ? "100%" : 260 }}>
                  <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 13, letterSpacing: 2, color: "rgba(140,100,30,0.85)", border: "1px solid rgba(180,140,80,0.25)", padding: "3px 10px", borderRadius: 1, display: "inline-block", marginBottom: 10 }}>{mix.tag}</span>
